...
SELECT s.FirstName, s.LastName, c.CourseName FROM Students JOIN Enrollments e ON s.StudentID = e.StudentID
...
SELECT c.CourseName FROM Courses LEFT JOIN Enrollments e ON c.CourseID = e.CourseID WHERE e.StudentID IS NULL;
